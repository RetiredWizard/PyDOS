...
if Pydos_hw.boardName == 'Adafruit Feather RP2040 with RP2040':
    led = Pin(13, Pin.OUT)
elif Pydos_hw.boardName == 'Adafruit ItsyBitsy RP2040 with RP2040':
    led = Pin(11, Pin.OUT)
elif Pydos_hw.boardName == 'Arduino Nano RP2040 Connect with RP2040':
    led = Pin(6, Pin.OUT)
elif Pydos_hw.led:
