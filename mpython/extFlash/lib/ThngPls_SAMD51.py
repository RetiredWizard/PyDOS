...
if "_TmpBasic" in os.listdir('/'):
    print("*ERROR* Either delete /_TmpBasic direectory or rename it to /PyBasic, To")
    print("reformat secondary flash (/PyBasic) create a file named")
    print("format_secondary_flash.___ in root folder and reset the board\n")
else:
