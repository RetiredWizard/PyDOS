...
2110 S8=INT(S1)*24+INT(S2)*3-26:IF MID$(Q$,S8,s8+2)="  " THEN 2140
...
2500 PRINT mid$(STR$(N(L)+1000),1,4);" ";
2510 NEXT L
2511 PRINT"|"
2512 PRINT "-"*19
2513 NEXT I
...
4331 PRINT mid$(STR$(Z(I,J)+1000),zlen-3,zlen);
4340 NEXT J
4341 GOTO 4370
4350 Z4=I:Z5=1
4351 GOSUB 5040
...
4851 Q$=A$+mid$(Q$,3,192):RETURN
4860 IF S8<>190 THEN 4870
4861 Q$=mid$(Q$,0,189)+A$:RETURN
4870 Q$=mid$(Q$,0,S8-1)+A$+mid$(Q$,s8+2,192):RETURN
