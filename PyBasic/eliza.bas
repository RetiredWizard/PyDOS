...
100 DIM S ( 36 ) :dim R ( 36 ) :dim N ( 36 ) 
105 DIM KEYWORD$ ( 27 ):DIM KWINDX(27):dim WORDIN$ ( 8 ):dim WORDOUT$ ( 8 ):dim REPLIES$ ( 112 ):DIM KEYWORD2$(5):DIM KWINDX2(5)
107 REM NEED TO PRE-DECLARE BEFORE USE
108 P$ = "NULL"
110 N1 = 27 : N2 = 16 : N3 = 112 : N4 = 36: N5 = 5
112 FOR X = 1 TO N1
113 READ TEMP$,TEMP: KEYWORD$ ( X ) = TEMP$: KWINDX(X) = TEMP
114 NEXT X 
115 FOR X = 1 TO N2 / 2
...
1100 DATA "BECAUSE", 22 , "COMPUTER", 35 , "COMPUTERS", 35, "NOKEYFOUND", 36 
1200 REM ********************************* 
...
2120 DATA "BUT YOU ARE NOT SURE*" 
2130 DATA "DO YOU DOUBT*" 
